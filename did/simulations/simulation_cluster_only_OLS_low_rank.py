...
def numerically_low_rank(m, n, r, eps=1e-3, decay="geom", *, device=None, dtype=None, seed=None):
    """
...
class DiD_DGP:
    ...
    def generate(self, n, seed=None):
        if seed is not None:
            torch.manual_seed(seed)
        X1 = numerically_low_rank(self.dim_X, n = n, r = 2, eps= .75, decay="power")
    ...
    def simulate_att_population(self, n=int(5e6), batch_size=int(5e5), seed=None):
        ...
        def run_batch(m):
            ...
            X1 = numerically_low_rank(self.dim_X, n = m, r = self.dim_X-2)
            X11 = X1[:, 0]
