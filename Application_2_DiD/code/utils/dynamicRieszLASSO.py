...
from .hyperparams import lasso_a_settings, lasso_f_settings
...
class Learner_a_LASSO:
    ...
    def __init__(self, lasso_a_settings = lasso_a_settings):
        """
        Parameters
        ----------
        """
...
class Learner_f_LASSO:
    ...
    def __init__(self, lasso_f_settings = lasso_f_settings):
        """
        Parameters
        ----------
        """
